        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Edat = table.Column<string>(type: "text", nullable: false),
                    Mida = table.Column<string>(type: "text", nullable: false),
                    Estat = table.Column<string>(type: "text", nullable: false),
                    Descripcio = table.Column<string>(type: "text", nullable: false),
                    ImatgeUrl = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Nom = table.Column<string>(type: "text", nullable: false),
                    Cognom = table.Column<string>(type: "text", nullable: false),
                    Email = table.Column<string>(type: "text", nullable: false),
                    Missatge = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    Tipus = table.Column<string>(type: "text", nullable: false),
                    AnimalId = table.Column<int>(type: "integer", nullable: true),
                    Resposta = table.Column<string>(type: "text", nullable: true),
                    RespostaEnviada = table.Column<bool>(type: "boolean", nullable: false),
